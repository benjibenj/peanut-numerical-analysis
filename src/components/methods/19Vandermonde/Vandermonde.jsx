...
const Vandermonde = ({ name }) => {
  ...
  return (
    <Method
      ...
      jsAlgorithm={
        "https://github.com/benjamin-vaysse/peanut-numerical-analysis/blob/master/src/components/methods/19Vandermonde/vandermondeFunction.js"
      }
      pseudoCode={
        "https://github.com/benjamin-vaysse/peanut-numerical-analysis/blob/master/src/components/methods/19Vandermonde/pseudoCode/vandermonde.pdf"
      }
    >
