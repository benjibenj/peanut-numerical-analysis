...
const LuPartial = ({ name }) => {
  ...
  return (
    <Method
      ...
      jsAlgorithm={
        "https://github.com/benjamin-vaysse/peanut-numerical-analysis/blob/master/src/components/methods/12LuPartial/luPartialFunction.js"
      }
      pseudoCode={
        "https://github.com/benjamin-vaysse/peanut-numerical-analysis/blob/master/src/components/methods/12LuPartial/pseudoCode/luPartial.pdf"
      }
    >
      <Inputs>
